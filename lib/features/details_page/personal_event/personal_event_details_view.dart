...
//   @override
//   State<PersonalEventDetailsView> createState() => _PersonalEventDetailsViewState();
// }
...
//         child: Column(
//           children: [
//             // 🔹 الشريط الأعلى: زر العودة + مؤشر النقاط في المنتصف
//             Padding(
...
//                     ),
//                   ),
//                   const SizedBox(width: 48), // لموازنة زر الباك في الهيدر
//                 ],
//               ),
//             ),
...
//     },
//     children:  [
//       EventInfoDisplayBody(),         // الصفحة 1: معلومات الفعالية
//       SelectedServicesDisplayBody(event: widget.event),  // الصفحة 2: الخدمات المحددة
//       EventTasksScreen(needsAppBar: false),             // الصفحة 3: المهام
//     ],
//   ),
// ),
//           ],
