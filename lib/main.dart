...
class MyApp extends StatelessWidget {
 final mockUser = User(
  id: 'u1',
  username: 'Rima',
  urlImage: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=200',
  personalEvents: [
    ...
    PersonalEvent(
      ...
      tasks: [
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(hours: 2)), // اليوم بعد ساعتين
          eventId: 'p1',
        ...
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(hours: 6)), // اليوم مساءً
          eventId: 'p1',
          eventTitle: 'حفلة تخرج',
          isDone: true,
        ...
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 1, hours: 4)), // غداً ظهراً
          eventId: 'p1',
          eventTitle: 'حفلة تخرج',
          isDone: false,
          priority: 1,
        ...
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 2, hours: -3)), // يوم الفعالية صباحاً
          eventId: 'p1',
          eventTitle: 'حفلة تخرج',
          isDone: false,
    ...
    PersonalEvent(
      ...
      tasks: [
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 1, hours: 2)), // بعد يوم
          eventId: 'p2',
        ...
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 3, hours: 5)), // بعد 3 أيام
          eventId: 'p2',
          eventTitle: 'مناقشة مشروع التخرج',
          isDone: false,
          priority: 1,
        ...
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 5, hours: 3)), // بعد 5 أيام
          eventId: 'p2',
          eventTitle: 'مناقشة مشروع التخرج',
          isDone: false,
          priority: 2,
        ...
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 6, hours: 8)), // قبل المناقشة بيوم
          eventId: 'p2',
          eventTitle: 'مناقشة مشروع التخرج',
          isDone: false,
          priority: 1,
    ...
    PersonalEvent(
      ...
      tasks: [
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 8, hours: 4)), // بعد 8 أيام
          eventId: 'p3',
        ...
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 10, hours: 6)), // بعد 10 أيام
          eventId: 'p3',
          eventTitle: 'رحلة نهاية الأسبوع',
          isDone: false,
          priority: 3,
        ...
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 11, hours: 5)), // قبل الرحلة بيوم
          eventId: 'p3',
          eventTitle: 'رحلة نهاية الأسبوع',
          isDone: false,
          priority: 2,
    ...
    PersonalEvent(
      ...
      tasks: [
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 15, hours: 4)), // بعد 15 يوم
          eventId: 'p4',
        ...
        TaskModel(
          ...
          dateTime: DateTime.now().add(const Duration(days: 17, hours: 2)), // قبل الحفلة بيوم
          eventId: 'p4',
          eventTitle: 'حفلة عيد ميلاد',
          isDone: true,
          priority: 3,
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        ...
        // ),// 🟢 2. توفير AuthCubit على مستوى التطبيق ككل
    BlocProvider(
      create: (context) => AuthCubit()..setUser(mockUser),
      child:  MyApp(),
    ),
      ],
